...
public abstract class CreateAdmissionRequestValidatorBase<T> : AbstractValidator<T>
    where T : CreateAdmissionRequest
{
    protected CreateAdmissionRequestValidatorBase()
    {
...
public class CreateAdmissionRequestValidator : CreateAdmissionRequestValidatorBase<CreateAdmissionRequest> { }